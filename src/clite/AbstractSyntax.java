...
class Program {
	// changed decpart->globals and
	// Block body->Functions functions
...
class Function {
	...
	public Function(Type t, Variable id, Declarations params,
...
class Call implements Expression, Statement {
	...
	public Call(Variable v, ArrayList<Expression> arguments) {
		this.v = v;
...
class Operator {
	...
	final static String boolMap[][] = { { AND, AND }, { OR, OR },
			{ EQ, BOOL_EQ }, { NE, BOOL_NE }, { LT, BOOL_LT }, { LE, BOOL_LE },
